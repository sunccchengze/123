...
power by 7--13\% in field campaigns \cite{Howland2019}, and wake-mixing controls impose
...
of all-or-none units with a stable rest state, super-threshold waves, a refractory recovery,
...
\item[Exp.\,7 (model dependence).] Wake kernel $\in\{$Jensen, Gaussian$\}$ across
$\lambda$ (Exp.~1 conditions); $\tau_r\in\{4,8,12,20\}$\,s $\times$ $k\in\{0.03,0.05,0.08\}$
at $\lambda\in\{4,8,12\}$.
\end{description}
