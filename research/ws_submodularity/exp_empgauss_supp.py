"""ARCHIVED P1/P2 exploratory supplement, not a robustness validation.

Finite-difference signs, optimizer states, and the in-place routine called
``djs`` do not restore the withdrawn P1/P2 claims. See ARCHIVE_NOTICE.md.
"""
