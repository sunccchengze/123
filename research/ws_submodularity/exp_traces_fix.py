"""ARCHIVED trace generator for a misnamed historical DJS routine.

The in-place coordinate updates are cyclic Gauss--Seidel rather than
frozen-state Jacobi. Its trace/timing values are not convergence or parallel
benchmark evidence. See ARCHIVE_NOTICE.md and p1_p2_forensic_audit.py.
"""
...
def djs(fm, y0, max_sweeps=6, trace=False):
    """Historical in-place cyclic Gauss--Seidel sweep, not Jacobi."""
