"""ARCHIVED P1 exploratory robustness script.

Its selected finite-difference/optimizer outputs do not establish decoupling or
a model-family interaction law. Retained for provenance; see ARCHIVE_NOTICE.md.
"""
