"""ARCHIVED conditional toy-model derivation.

It does not prove a result for FLORIS GCH or a physical wind farm. The former
P1 transfer and phase claims were withdrawn; see THEORY.md and ARCHIVE_NOTICE.md.
"""
